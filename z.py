...
oepoll = OEPoll(cl)
call = cl
creator = ["ub45bf3a8805030b9d7c5877e8e405449","ucccca2ada2b522c6d59e6640f29aafd0"]
owner = ["ub45bf3a8805030b9d7c5877e8e405449","ucccca2ada2b522c6d59e6640f29aafd0"]
admin = ["ub45bf3a8805030b9d7c5877e8e405449","ucccca2ada2b522c6d59e6640f29aafd0"]
staff = ["ub45bf3a8805030b9d7c5877e8e405449","ucccca2ada2b522c6d59e6640f29aafd0"]
mid = cl.getProfile().mid
Amid = ki.getProfile().mid
Bmid = ka.getProfile().mid
Zmid = k1.getProfile().mid
Nmid = k2.getProfile().mid
Gmid = k3.getProfile().mid
Cmid = kc.getProfile().mid
ABC = [ki,ka,k1,k2,k3]
Bots = [mid,Amid,Bmid,Cmid,Zmid,Nmid,Gmid]
...
responsename = k1.getProfile().displayName
responsename = k2.getProfile().displayName
responsename = k3.getProfile().displayName
...
wait = {
    ...
    "comment":"Auto like By.⌛'ƵɑႦαƙυ ₦ǿ Ǥααℓα'⌛",
    "comment1":"Auto like By.⌛'ƵɑႦαƙυ ₦ǿ Ǥααℓα'⌛",
    "message":"😁😁",
}
...
#    helpMessage += "╚═════════════╝\n" 
    ...
    num = (num+1)
    helpMessage += "╠❂➣ ║%i. " % num + key + ".Bye/Bye1-5/Bye.\n"
    num = (num+1)
...
def helpbot():
    ...
    key = key.title()
    helpMessage2 = "╔═════════════╗\n"
    helpMessage2 += "║      By.เอ้สายเทส\n"
    helpMessage2 += "╚═════════════╝\n" 
    helpMessage2 += "╠❂➣ ║%i. " % num + key + "Cv @\n"
    num = (num+1)
    ...
    num = (num+1)
    helpMessage2 += "╠❂➣ ║%i. " % num + key + "Autoblock on/off\n"
    num = (num+1)
                ...
                try:
                    ...
                    try:
                        ...
                        try:
                            ...
                            try:
                                if k1.getGroup(op.param1).preventedJoinByTicket == True:
                                    if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                                ...
                                try:
                                    if k2.getGroup(op.param1).preventedJoinByTicket == True:
                                        if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                                    ...
                                    try:
                                        if k3.getGroup(op.param1).preventedJoinByTicket == True:
                                            if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
...
#____________________________________________________________________
        ...
        if op.type == 5:
            ...
            if wait["autoAdd"] == True:
                ka.blockContact(op.param1)
            if wait["autoAdd"] == True:
                k1.blockContact(op.param1)
            if wait["autoAdd"] == True:
                k2.blockContact(op.param1)
            if wait["autoAdd"] == True:
                k3.blockContact(op.param1)
            if wait["autoAdd"] == True:
...
#                               cl.sendMessage(msg.to, "On bos siap hajar😈")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in owner or msg._from in admin or msg._from in staff:
                               ...
                               cl.sendMessage(msg.to, None, contentMetadata={'mid': Nmid}, contentType=13)
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in owner:
                              ...
                              if ginvited != [] and ginvited != None:
                                  ...
                                  k1.sendMessage(to, "Nothing sᴇᴍᴜᴀ ɢʀᴜᴘ sᴜᴅᴀʜ ᴅɪʙᴀᴛᴀʟᴋᴀɴ")
                                  k2.sendMessage(to, "Nothing sᴇᴍᴜᴀ ɢʀᴜᴘ sᴜᴅᴀʜ ᴅɪʙᴀᴛᴀʟᴋᴀɴ")
                                  k3.sendMessage(to, "Nothing sᴇᴍᴜᴀ ɢʀᴜᴘ sᴜᴅᴀʜ ᴅɪʙᴀᴛᴀʟᴋᴀɴ")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in owner:
                               try:
                                   ...
                                   k1.sendMessage(msg.to,"Bersih bos")
                                   k2.sendMessage(msg.to,"Bersih bos")
                                   k3.sendMessage(msg.to,"Bersih bos")
                               except:
                                   pass
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in owner:
                               ...
                               if key in [""," ","\n",None]:
                                   ...
                                   cl.sendMessage(msg.to, "🔴name change \n\nname succes change to {}".format(str(key).lower()))

                        elif text.lower() == "reset name":
                          if wait["selfbot"] == True:
                            if msg._from in owner:
                               Setmain["keyCommand"] = ""
...
#                               time.sleep(0.0008)
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               ki.sendMessage(msg.to, "⌛'ƵɑႦαƙυ ₦ǿ Ǥααℓα'⌛")
                               ka.sendMessage(msg.to, "⌛'ƵɑႦαƙυ ₦ǿ Ǥααℓα'⌛")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                G = cl.getGroup(msg.to)
                                kc.sendMessage(msg.to, "ลาก่อย บายๆ "+str(G.name))
...
#                               time.sleep(0.0008)
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in owner or msg._from in admin:
                               ...
                               k1.sendMessage(msg.to, "Time:\n{}".format(str(elapsed_time)))
                               k2.sendMessage(msg.to, "Time:\n{}".format(str(elapsed_time)))
                               k3.sendMessage(msg.to, "Time:\n{}".format(str(elapsed_time)))
                              ...
                              if spl == 'on':
                                  ...
                                  cl.sendMessage(msg.to, "Activated \n\n" + msgs)
                                    ...
                                    if msg.to in protect["pinv"]:
                                         ...
                                         msgs = "Protect invite has been disable"
                                    cl.sendMessage(msg.to, "Nonactive\n\n" + msgs)
...
#===========COMMAND ON OFF============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in owner:
                                wait["autoAdd"] = False
                                cl.sendMessage(msg.to,"Auto block dinonaktifkan")
